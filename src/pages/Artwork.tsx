...
export default function Artwork() {
  ...
  return (
    <div className="max-w-350 px-4 mx-auto">
      <button className="bg-red-200" onClick={next}>
        next button
      </button>
      <div className="lg:hidden p-6 flex flex-col justify-center gap-8">
        <div className="flex items-center justify-between gap-8">
          <h1 className="text-center text-3xl font-title italic font-bold">
            {art.title}
          </h1>
      ...
      <div className="hidden lg:grid grid-cols-[4fr_5fr] max-w-[1400px] gap-8">
        ...
        <div className="flex flex-col">
          <div className="flex items-center justify-between gap-8 mb-32">
            <h1 className="text-center text-4xl font-title italic font-bold">
              {art.title}
            </h1>
...
function MetaData({ children }: { children: ReactNode }) {
  return <div className="bg-slate-200 rounded px-4 py-2">{children}</div>;
}
